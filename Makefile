...
quiz-en: common-en
	$(SOY_COMPILER) --outputPathFormat appengine/quiz/generated/en/soy.js --srcs appengine/quiz/template.soy
	python build-app.py quiz en
