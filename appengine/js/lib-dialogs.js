...
BlocklyDialogs.congratulations = function() {
  console.log("BlocklyDialog.congratulations");
  ...
  if (BlocklyInterface.workspace) {
    console.log(BlocklyInterface.workspace);
 ...
 * 
 */
BlocklyDialogs.doTest = function() {
  console.log("BlocklyDialog.doTest");
  /*var xml = [
    '<xml>',
      ...
      '</block>',
    '</xml>'];
  BlocklyInterface.injectReadonly('quiz_blocks', xml);*/
  var content = document.getElementById('dialogQuiz');
  if (content == null){
  ...
  //var linesText = document.getElementById('dialogLinesTextQuiz');
  //linesText.textContent = null;

  var quiz_answer_25 = document.getElementById('quiz25'); 
  var quiz_answer_30 = document.getElementById('quiz30'); 
  var quiz_answer_35 = document.getElementById('quiz35'); 
  ...
  //document.getElementById('dialogDoneTextQuiz').textContent = text;
};
