...
Index.init = function() {
  ...
  // Conner store my point to local storage
  if (window.localStorage['my_point_store'] == null){
    console.log("my point undefined");
    window.localStorage['my_point_store'] = '0';
  }
  console.log("my point "+ window.localStorage['my_point_store']);
  ...
  // Conner get my point form local storage and display it to <div id=my_point>.
  var my_point_div = document.getElementById('my_point_index');
  my_point_div.textContent = window.localStorage['my_point_storage'] 

  // Conner bind clearButton handler 
  BlocklyGames.bindClick('clearButton', Index.clearMyPoint);
...
Index.clearData_ = function() {
  ...
  // Conner When to delete game data, also delete my point.
  window.localStorage['my_point_storage'] = '0'
  location.reload();
};
 ...
 *  
 */
// Conner clearButton handler 
Index.clearMyPoint = function(){
  console.log("clear my point");
  window.localStorage['my_point_storage'] = '0';
  var indexMyPointDiv = document.getElementById('my_point_index');
  indexMyPointDiv.textContent = window.localStorage['my_point_storage']
