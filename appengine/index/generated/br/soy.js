...
Index.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="title">C\'hoario\u00F9 Blockly</span><span id="Index_clear">Lemel holl ho tiskoulmo\u00F9 ?</span></div>';
};
if (goog.DEBUG) {
...
Index.soy.start = function(opt_data, opt_ignored, opt_ijData) {
  return Index.soy.messages(null, null, opt_ijData) + '<div id="header"><img id="banner" src="index/title-beta.png" height="51" width="244" alt="Blockly Games"><div id="subtitle">C\'hoario\u00F9 evit programmerien warc\'hoazh. &nbsp;' + ((opt_ijData.html) ? '<a href="about.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">' : '<a href="about?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '">') + 'Titouro\u00F9 pedagogel...</a></div></div><svg height="100%" width="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g transform="translate(-150,-60)"><svg height="100%" width="100%" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" preserveAspectRatio="none" x="150" y="60"><path id="path" d="M 10,15 C 15,60 35,100 50,70 S 80,20 90,85"' + ((opt_ijData.rtl) ? 'transform="translate(100) scale(-1, 1)"' : '') + '/></svg>' + Index.soy.appLink({app: 'puzzle', x: 10, y: 15, contentText: 'Miltamm'}, null, opt_ijData) + Index.soy.appLink({app: 'maze', x: 16, y: 45, contentText: 'Milendall'}, null, opt_ijData) + Index.soy.appLink({app: 'bird', x: 26, y: 69, contentText: 'Labous'}, null, opt_ijData) + Index.soy.appLink({app: 'turtle', x: 41, y: 80, contentText: 'Baot'}, null, opt_ijData) + Index.soy.appLink({app: 'movie', x: 55, y: 61, contentText: 'Film'}, null, opt_ijData) + Index.soy.appLink({app: 'music', x: 69, y: 43, contentText: 'Sonerezh'}, null, opt_ijData) + Index.soy.appLink({app: 'pond-tutor', x: 83, y: 55, contentText: 'Tutorial Stank'}, null, opt_ijData) + Index.soy.appLink({app: 'pond-duck', x: 90, y: 85, contentText: 'Stank'}, null, opt_ijData) + '</g></svg><select id="languageMenu"></select><p id="clearDataPara" style="visibility: hidden">Ha c\'hoant ho peus da adkregi\u00F1 ?<button class="secondary" id="clearData">Nulla\u00F1 ar roadenno\u00F9</span></button></p>';
};
if (goog.DEBUG) {
