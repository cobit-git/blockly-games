...
Puzzle.init = function() {
  ...
  var my_point_div_puzzle = document.getElementById('my_point_puzzle');
  my_point_div_puzzle.textContent = window.localStorage['my_point_storage']
...
Puzzle.checkAnswers = function() {
  ...
  if (badBlocks.length) {
    ...
    // Conner puzzle completed 
    console.log('Puzzle completed! my point is 10.')
    window.localStorage['my_point_storage'] = '10';
