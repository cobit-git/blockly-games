...
BlocklyGames.soy.headerBar = function(opt_data, opt_ignored, opt_ijData) {
  return '<table width="100%"><tr><td><h1>' + BlocklyGames.soy.titleSpan(opt_data, null, opt_ijData) + ((opt_ijData.level) ? BlocklyGames.soy.levelLinks({suffix: '' + ((opt_data.levelLinkSuffix) ? soy.$$escapeHtml(opt_data.levelLinkSuffix) : '')}, null, opt_ijData) : '') + '</h1></td><td id="header_cta" class="farSide"><select id="languageMenu"></select>' + ((opt_data.hasLinkButton) ? '&nbsp;<button id="linkButton" title="\u0627\u062D\u0641\u0638 \u0648\u0623\u0639\u0637\u064A \u0648\u0635\u0644\u0629 \u0625\u0644\u0649 \u0627\u0644\u0628\u0644\u0648\u0643\u0627\u062A."><img src="common/1x1.gif" class="link icon21"></button>' : '') + ((opt_data.hasHelpButton) ? '&nbsp;<button id="helpButton">\u0645\u0633\u0627\u0639\u062F\u0629</button>' : '') + ((opt_data.farLeftHtml) ? '&nbsp;' + soy.$$filterNoAutoescape(opt_data.farLeftHtml) : '') + '</td></tr></table>';
};
if (goog.DEBUG) {
...
BlocklyGames.soy.abortDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogAbort" class="dialogHiddenContent">\u0647\u0630\u0647 \u0627\u0644\u0645\u0631\u062D\u0644\u0629 \u0635\u0639\u0628\u0629 \u0644\u0644\u063A\u0627\u064A\u0629\u060C \u0647\u0644 \u062A\u0631\u063A\u0628 \u0641\u064A \u062A\u062E\u0637\u064A \u0630\u0644\u0643 \u0648\u0627\u0644\u0630\u0647\u0627\u0628 \u0625\u0644\u0649 \u0627\u0644\u0644\u0639\u0628\u0629 \u0627\u0644\u062A\u0627\u0644\u064A\u0629\u061F \u064A\u0645\u0643\u0646\u0643 \u062F\u0627\u0626\u0645\u0627 \u0627\u0644\u0639\u0648\u062F\u0629 \u0641\u064A \u0648\u0642\u062A \u0644\u0627\u062D\u0642.<div class="farSide" style="padding: 1ex 3ex 0"><button id="abortCancel">\u0625\u0644\u063A\u0627\u0621</button><button id="abortOk" class="secondary">\u0645\u0648\u0627\u0641\u0642</button></div></div>';
};
if (goog.DEBUG) {
