...
BlocklyGames.soy.levelLinks = function(opt_data, opt_ignored, opt_ijData) {
  var output = ' &nbsp; ';
  var iLimit219 = opt_ijData.maxLevel + 1;
  for (var i219 = 1; i219 < iLimit219; i219++) {
    var url__soy220 = '?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i219) + ((opt_data.suffix) ? '&' + soy.$$escapeHtml(opt_data.suffix) : '');
    output += ' ' + ((i219 == opt_ijData.level) ? '<span class="level_number level_done" id="level' + soy.$$escapeHtml(i219) + '">' + soy.$$escapeHtml(i219) + '</span>' : (i219 == opt_ijData.maxLevel) ? '<a class="level_number" id="level' + soy.$$escapeHtml(i219) + '" href="' + soy.$$escapeHtml(url__soy220) + '">' + soy.$$escapeHtml(i219) + '</a>' : '<a class="level_dot" id="level' + soy.$$escapeHtml(i219) + '" href="' + soy.$$escapeHtml(url__soy220) + '"></a>');
  }
  return output;
};
if (goog.DEBUG) {
...
BlocklyGames.soy.quizDialog = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="dialogQuiz" class="dialogHiddenContent"><div style="font-size: large; margin: 1em;">Let\'s test!</div><div id="dialogLinesTextQuiz" style="font-size: large; margin: 1em;"></div><div id="quiz_blocks" class="readonly"><xml><block type="quiz_init" x="5" y="5"><value name="NUMBER"><block type="quiz_var"></block></value><next><block type="quiz_repeat"><statement name="LOOP"><block type="quiz_add"><value name="NUMBER"><block type="quiz_var"></block></value></block></statement></block></next></block></xml></div><div id="dialogDoneButtonsQuiz" class="farSide" style="padding: 1ex 3ex 0"><button id="quiz25">25</button><button id="quiz30" class="secondary">30</button><button id="quiz35" class="secondary">35</button></div></div>';
};
if (goog.DEBUG) {
  BlocklyGames.soy.quizDialog.soyTemplateName = 'BlocklyGames.soy.quizDialog';
}
...
BlocklyGames.soy.answer_1 = function(opt_data, opt_ignored, opt_ijData) {
  return '<div class="farSide" style="padding: 1ex 3ex 0"><button class="secondary" onclick="BlocklyDialogs.hideDialog(true)">25</button></div>';
};
if (goog.DEBUG) {
  BlocklyGames.soy.answer_1.soyTemplateName = 'BlocklyGames.soy.answer_1';
}
